...
# 튜플의 요솟값을 지우거나 변경하려고 하면 어떨게 될까?
앞에 설명했듯이 튜플의 요솟값은 한 번 정하면 지우거나 변결할 수 없다. 다음에 소개하는 두 예를 살펴보면 무슨 말인지 알 수 있을 것이다.
...
t_1[3]
'b'
문자열, 리스트와 마찬가지로 t_1[0],t_1[3]처럼 인덱싱이 가능하다.

슬라이싱하기
t_1 = (1,2,'a','b')
t_1[1:]
(2,'a','b')
t_1[1]부터 튜플의 마지막 요소까지 슬라이싱하는 예이다.
